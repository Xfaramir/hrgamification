...
class Add59dfeeff79eafRelationshipsToEmployeeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('employees', function(Blueprint $table) {
            if (!Schema::hasColumn('employees', 'employee_username_id')) {
                ...
                $table->foreign('employee_status_id', '81322_59dfeefe2e279')->references('id')->on('statuses')->onDelete('cascade');
                }
