...
class CoursesController extends Controller
{
    ...
    public function create()
    {
        ...
        $engament_skills = \App\Skill::get()->pluck('skill_name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');

        return view('admin.courses.create', compact('engament_skills'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.courses.edit', compact('course', 'engament_skills'));
    }
