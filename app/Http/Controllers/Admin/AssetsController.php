...
class AssetsController extends Controller
{
    ...
    public function create()
    {
        ...
        $assigned_tos = \App\Employee::get()->pluck('employee_id', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function edit($id)
    {
        ...
        return view('admin.assets.edit', compact('asset', 'categories', 'statuses', 'locations', 'assigned_tos'));
    }
    ...
    public function show($id)
    {
        ...
        $statuses = \App\AssetsStatus::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $locations = \App\AssetsLocation::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $assigned_tos = \App\Employee::get()->pluck('employee_id', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$assets_histories = \App\AssetsHistory::where('asset_id', $id)->get();
