        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('subject', trans('quickadmin.news.fields.subject').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('published_date', trans('quickadmin.news.fields.published-date').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('published_date', old('published_date'), ['class' => 'form-control date', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
