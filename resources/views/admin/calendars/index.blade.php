...
@section('content')
    ...
    @can('calendar_create')
    <p>
        <a href="{{ route('admin.calendars.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
    ...
    <p>
        <ul class="list-inline">
            <li><a href="{{ route('admin.calendars.index') }}" style="{{ request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">@lang('quickadmin.qa_all')</a></li> |
            <li><a href="{{ route('admin.calendars.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">@lang('quickadmin.qa_trash')</a></li>
        </ul>
    </p>
    @endcan
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            window.dtDefaultOptions.columns = [
                ...
                @endif
                @endcan
                {data: 'calendar_event', name: 'calendar_event'},
                {data: 'calendar_time', name: 'calendar_time'},
                {data: 'calendar_location', name: 'calendar_location'},
                {data: 'calendar_description', name: 'calendar_description'},
                {data: 'calendar_photo', name: 'calendar_photo'},
