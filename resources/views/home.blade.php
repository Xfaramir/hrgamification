            ...
            <div class="col-md-8">
                    ...
                    <div class="box-body no-padding">
                        <div class="row">
                            <div class="col-md-9 col-sm-8 visible-xs-block, hidden-xs">
                                <div id="world-map" style="max-width: 650px; height: 380px"></div>
                            </div>
                            <!-- /.col -->
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">@lang('quickadmin.latestvacancies')</h3>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                <thead>
                                <tr>
                                    <th>@lang('quickadmin.vacantid')</th>
                                    <th>@lang('quickadmin.vacanttitle')</th>
                                    <th>@lang('quickadmin.vacantpublished')</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach ($vacancies as $vacant)
                                    <tr>
                                        ...
                                        <td><a href="pages/examples/invoice.html">{{$vacant->id}}</a></td>
                                        <td>{{$vacant->vacancy_name}}</td>
                                        <td><span class="label label-success">{{$vacant->vacancy_date}}</span></td>
                                        <td>
                    ...
                    <div class="box-footer clearfix">
                        <a href="admin/vacancies" class="btn btn-sm btn-info btn-flat pull-left">Apply To Vacancies</a>
